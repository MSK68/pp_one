"""
Этот замечательный скрипт помогает запустить приложение gradio.
"""
...
def summ(articleInput, min_length_of_article, max_length_of_article) -> str:
    """
...
summarizer_pipline = pipeline('summarization', model="d0rj/rut5-base-summ")  # Модель суммаризации
